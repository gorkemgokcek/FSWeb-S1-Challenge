...
const newArray = fenomenEkle(fenomenler, 6, "Workintech", 10000000, 2022, "Instagram" );
...
function fenomenGonderimSayisi(dizi,profilName){
  for(let i = 0; i<dizi.length ; i++){
    const fenomen = dizi[i]
    if(fenomen.profile === profilName){
